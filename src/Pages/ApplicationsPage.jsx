...
export default function ApplicationsPage(){
    ...
    return(
        ...
        <MainSpace>
            <div className="subject-section"><h1 className="application-section text-secondary font-extrabold">{userDetails.application?userDetails.application:"Content available after completing Placement preparation"}</h1></div><br/><br/><br/>
        </MainSpace>
    )
}