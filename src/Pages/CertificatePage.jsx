...
export default function CertificatePage(){
    ...
    return(
        ...
        <MainSpace>
             <div className="subject-section"><h1 className="certificate-section text-neutral">{userDetails.certificate?userDetails.certificate:"Your Certificate is not yet Generated"}</h1></div>
             <br/><br/><br/>
        </MainSpace>
    )
}